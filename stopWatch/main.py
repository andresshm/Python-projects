...
def create_window():
    ...
    sg.theme('black')
    layout = [
        [sg.Push(), sg.Image('imagenes/cruz.png', pad=0, enable_events=True, key='-CLOSE-')],
        [sg.VPush()], # hace espacio verticalmente
        [sg.Text('', font='Calibri 50', key='-TIME-')],
        [
...
while True:
    ...
    else: # para que no salga el warning en el elapsed del if de abajo pero no hace falta
        elapsed_time = 0
    if event == '-LAP-':
